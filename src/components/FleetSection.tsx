...
import { reveal, drift, tap, ease, viewport } from '../utils/motion';
...
export function FleetSection() {
  ...
  return (
    <section
      id="fleet"
      className="relative pt-[calc(5vw+2rem)] pb-[calc(5vw+2rem)] md:pt-[calc(5vw+3rem)] md:pb-[calc(5vw+2.5rem)] bg-bg-primary -mt-[5vw] [clip-path:polygon(0_5vw,100%_0,100%_100%,0_100%)]"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-4 md:mb-6 pt-4">
          <motion.span
            ...
            className="text-gold text-eyebrow mb-2 block"
          >
            Our Fleet
          </motion.span>
          <motion.h2
            ...
            className="text-heading-md-fluid font-serif text-text-primary mb-2"
          >
          ...
          <motion.p
            ...
            className="text-text-secondary max-w-2xl mx-auto text-caption"
          >
      ...
      <div className="relative">
        ...
        <div className="overflow-hidden w-full">
          <motion.div
            ...
            transition={{ duration: 0.6, ease: ease.glide as unknown as number[] }}
          ...
          >
            {vehicles.map((vehicle, i) => (
              ...
              >
                <motion.div
                  animate={{
                    scale: i === currentIndex ? 1 : 0.88,
                    opacity: i === currentIndex ? 1 : 0.65,
                  }}
                  transition={{ duration: 0.5, ease: ease.glide as unknown as number[] }}
                ...
                >
                  <img
                    src={vehicle.image}
                    alt={vehicle.name}
                    className="w-full h-auto object-contain mx-auto dark:drop-shadow-[0_0_30px_rgba(205,168,78,0.3)] dark:brightness-110"
                  />
                </motion.div>
              </div>
            ))}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mt-2">
          <h3 className="text-heading-xs font-serif text-text-primary mb-0.5">
            {currentVehicle.category}
          </h3>
          <p className="text-caption text-text-secondary mb-2">
            {currentVehicle.description}
          </p>
          <div className="flex items-center justify-center gap-6 text-caption text-text-secondary">
